...
if __name__=="__main__":
    ...
    vit, txt, tok = load_models(device)           # your helper
    ...
    sae  = SparseAutoencoder(input_dim=1152, hidden_dim=512, sparsity_weight=1e-3)
    train_sae(sae, dl, n_epochs=10, lr=1e-3, device=device)
    
    ckpt_path = f"checkpoints/sae_layer{layer_idx + 1}.pt"
